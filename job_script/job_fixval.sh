...
log_server=job_logs/bash_fixval_server.log
log_train=job_logs/bash_fixval_train.log
job_server=examples/train/r2e_swe/r2e_server_async.sh
job_train=examples/train/r2e_swe/train_r2eagent_7B_bs128_20K_async_fix_valset.sh
