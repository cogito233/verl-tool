...
log_server=job_logs/bash_7B_magic_server_0703_aftermerge_DAPO.log
log_train=job_logs/bash_7B_magic_train_0703_aftermerge_DAPO.log
job_server=examples/train/r2e_swe/r2e_server_mnode.sh
job_train=examples/train/r2e_r2e/train_r2eagent_7B_magic_DAPO.sh
