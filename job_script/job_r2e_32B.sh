...
log_server=job_logs/bash_32B_lite_server.log
log_train=job_logs/bash_32B_lite_train.log
job_server=examples/train/r2e_swe/r2e_server_mnode.sh
job_train=examples/train/r2e_r2e/train_r2eagent_32B_bs256_32K_async_fix_valset_mnode.sh
