...
Then execute:
    python -m verl_tool.servers.tests.test_1 browser \
        --url=http://localhost:5000/get_observation
"""
...
# Browser tests
# ───────────────────────────────────────────────
def test_1(url: str = "http://localhost:5000/get_observation",
    ...
    action_str2 = (
        "Locate William Bradley Pitt on Wikipedia\n"
        "```type [18] [William Bradley Pitt] [1]```"
    )

    actions = ["", action_str1, action_str2]
