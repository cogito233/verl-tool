...
model_name=qwen25_7b_coder_swe_extra_deepswe
model_path=/data/minimax-dialogue/users/ruobai/LLaMA-Factory/saves/Qwen2.5-Coder-7B-Instruct-RFT-SWE-EXTRA-DEEPSWE-1ep
