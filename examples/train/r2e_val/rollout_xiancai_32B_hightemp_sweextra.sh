...
model_name=Xiancai-32B-RFT-SWE-EXTRA-1ep
model_path=/data/minimax-dialogue/users/ruobai/LLaMA-Factory/saves/Xiancai-32B-RFT-SWE-EXTRA-1ep
# Qwen2.5-Coder-7B-Instruct-RFT-SWE-EXTRA-DEEPSWE-1ep
