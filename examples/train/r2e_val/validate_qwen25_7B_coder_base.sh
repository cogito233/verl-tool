...
model_name=qwen25_7b_coder_sync_extra_deepswe
model_path=/data/minimax-dialogue/users/ruobai/LLaMA-Factory/saves/Qwen2.5-Coder-7B-Instruct-RFT-SYNC-EXTRA-DEEPSWE-1ep
