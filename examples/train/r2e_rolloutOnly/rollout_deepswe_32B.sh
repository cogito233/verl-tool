...
# Something Random
val_data=/root/code/rl_r2e/data/r2e_sync_extra_user/test.parquet
val_data_name=r2e_sync_extra_user
model_name=DeepSWE-Preview
model_path=/data/minimax-dialogue/users/ruobai/cogito/base_model/DeepSWE-Preview
