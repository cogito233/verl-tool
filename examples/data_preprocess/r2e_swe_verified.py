...
def build_instances(data, split_name):
    ...
    for row_i, row in enumerate(data):
        ...
        instance = {
            ...
            "extra_info": {
                "split": split_name,
                "index": row["repo"] + "_" + row["base_commit"],
                "id": row["repo"] + "_" + row["base_commit"],
                "row_i": row_i,
                "ds": row
            }
        }
...
def build_dataset(dataset_name, dataset_path):
    ...
    print("Done! Test size:", len(test_dataset))



if __name__ == "__main__":
    dataset_name = "r2e_swe_verified"
    dataset_path = "/data/minimax-dialogue/users/xiaojun/r2e-gym/datasets/swe-bench-verified"
